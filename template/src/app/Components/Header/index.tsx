...
export default function Header({ variant }: HeaderProps) {
  ...
  return(
    <HeaderStyle2 variant={undefined}></HeaderStyle2>
  )
          ...
          <div className="cs_top_header_in">
            <div className="cs_top_header_left">
              <ul className="cs_top_nav d-flex flex-wrap align-items-center cs_fs_12 text-white m-0 p-0">
                ...
                <li>
                  <a href="tel:+14185547569" className="text-white">
                    <span>+1 (418) 554-7569</span>
                  </a>
                </li>
                <li>
                  <a href="mailto:soumission@solutiondouxconfort.com" className="text-white">
                    <i className="cs_icon cs_icon_mail"></i>
                    soumission@solutiondouxconfort.com
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="cs_main_header_in">
            <div className="cs_main_header_left">
              <Link className="cs_site_branding" href="/">
                  <Image src="/logo-600x269.png" alt="Logo" width={150} height={35}   />
              </Link>
              </div>
