        ...
        <div className="cs_about cs_style_1">
            ...
            <div className="row align-items-center cs_gap_y_40">
                ...
                <div className="cs_about_thumb">
                    <Image src={Img} alt="À propos" width={636} height={617}  objectFit="cover"  />
                </div>
                </div>
                ...
                <div className="cs_about_content">
                    ...
                    <Image src="/assets/img/icons/fan.svg" alt="À propos" className="cs_section_subheading_icon" width={15} height={15}   />
                        {TitleUp}
                    </h3>
                   <h2 className="cs_section_title cs_fs_48 cs_semibold mb-0">{Title}</h2>
                    ...
                    <div className="cs_tab_body">
                        ...
                        {FeatureList?.map((item, index) => (
                            <li key={index}>
                               <Image src="/assets/img/right-arrow.png" alt="À propos" width={18} height={18}   /> 
                            {item}
                            </li>
                        ))}
                        </ul>
