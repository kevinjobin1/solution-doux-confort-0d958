        ...
        {data.map((item, i) => (
          <div key={i} className="col-lg-4 col-md-6">
            <div className="cs_service_card cs_style_1 text-center">
              <div className="cs_service_card_in px-4 pt-5 pb-4">
                {/* <p className="cs_service_card_number cs_center cs_fs_48 cs_bold cs_mb_22">{item.id}</p> */}
                <div className="cs_service_card_number cs_center cs_fs_48 cs_bold cs_mb_22 "> <Image src={item.img} alt="img" width={40} height={40}   /></div>
              ...
              {/* <div className="cs_service_card_icon cs_center "> <Image src={item.img} alt="img" width={40} height={40}   /></div> */}
              <div className="cs_service_card_bg" >
                <svg width="487" height="485" viewBox="0 0 487 485" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M66 358.001H417V375.001C417 402.615 394.614 425.001 367 425.001H116C88.3858 425.001 66 402.615 66 375.001V358.001Z" fill="white"/>
                   ...
                   {/* <path d="M403 342.501L413.612 332.268C414.882 331.044 417 331.944 417 333.708V358.001H386L403 342.501Z" fill="#1a5d98"/>
                  <path d="M80.5 342.001L69.8593 330.98C68.6209 329.698 66.45 330.554 66.4207 332.337L66 358.001H97L80.5 342.001Z" fill="#bf4e2f"/> */}
